...
const translations = {
    es: {
        ...
        "service-bullet-corporate-1": "Hasta 5 Páginas Propias: Secciones independientes para Inicio, Servicios detallados, Quiénes Somos y Contacto.",
        "service-bullet-corporate-2": "Preparada para Google (SEO): Estructura técnica optimizada para ayudarte a posicionar tu negocio en tu zona.",
        "service-bullet-corporate-3": "Contacto y Mapas Avanzados: Formulario a medida y mapa interactivo de Google Maps para que te encuentren fácil.",
        "service-bullet-corporate-4": "Analítica e Indexación: Alta en Google para asegurar que tu web existe en internet y puedas medir tus visitas.",
        ...
        "portfolio-subtitle": "Propuestas visuales que he diseñado pensando en las necesidades específicas de los comercios locales.",
        ...
        "proj-desc-1": "Un concepto moderno para restauración: visualización rápida de la carta en móviles, integración de reservas directas a WhatsApp y valoraciones de clientes destacadas.",
        "proj-link-1": "Quiero algo similar para mi local",
        
        "proj-title-2": "Fisioterapia Bufalà",
        "proj-desc-2": "Diseño web adaptado a clínicas o profesionales de salud: presentación limpia de especialidades y un sistema de citas online sencillo para los pacientes.",
        "proj-link-2": "Quiero algo similar para mi local",
        
        "proj-title-3": "BadaModa Boutique",
        "proj-desc-3": "Landing page de captación para tiendas de ropa locales: catálogo de colecciones integrado y botón de compra rápido a través de WhatsApp Business.",
        ...
        "error-message": "Escribe un breve mensaje describiendo tu necesidad (mínimo 10 caracteres).",
    ...
    ca: {
        ...
        "portfolio-subtitle": "Propostes visuals que he dissenyat pensant en les necessitats específiques dels comerços locals.",
        ...
        "proj-desc-1": "Un concepte modern per a restauració: visualització ràpida de la carta en mòbils, integració de reserves directes a WhatsApp i valoracions de clients destacades.",
        "proj-link-1": "Vull una cosa similar per al meu local",
        
        "proj-title-2": "Fisioteràpia Bufalà",
        "proj-desc-2": "Disseny web adaptat a clíniques o professionals de salut: presentació neta d'especialitats i un sistema de cites online senzill per als pacients.",
        "proj-link-2": "Vull una cosa similar per al meu local",
        
        "proj-title-3": "BadaModa Boutique",
        "proj-desc-3": "Landing page de captació per a botigues de roba locals: catàleg de col·leccions integrat i botó de compra ràpid a través de WhatsApp Business.",
        ...
        "error-message": "Escriu un breu missatge descrivint la teva necessitat (mínim 10 caràcters).",
    ...
    en: {
        ...
        "portfolio-subtitle": "Visual proposals I designed with the specific needs of local businesses in mind.",
        ...
        "proj-title-1": "Restaurant \"El Racó\"",
        "proj-desc-1": "A modern concept for dining: quick mobile menu display, direct WhatsApp bookings, and integrated Google Maps review highlights.",
        "proj-link-1": "I want something like this for my business",
        
        "proj-title-2": "Bufalà Fisiotherapy",
        "proj-desc-2": "Responsive web mockup for health clinics: clean presentation of treatments and a simple booking system for patients.",
        "proj-link-2": "I want something like this for my business",
        
        "proj-title-3": "BadaModa Boutique",
        "proj-desc-3": "Lead capture landing page for clothing shops: catalog display and rapid checkout buttons redirecting straight to WhatsApp Business.",
        ...
        "error-message": "Please write a short message describing your needs (minimum 10 characters).",
